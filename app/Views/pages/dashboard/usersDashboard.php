                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?= $this->include('pages/dashboard/partials/usersModal') ?>
                            <div class="card-body">
...
function simpan() {
  ...
  var url = id ? `${base_url}dashboard/users/update/${id}` : `${base_url}dashboard/users`;
...
function edit(id) {
    fetch(`${base_url}dashboard/users/update/${id}`)
    .then(response => response.json())
    .then(data => {
        console.log(data);
        $('#id').val(data.id);
...
function deleteItem(id) {
    ...
    fetch(`${base_url}dashboard/users/delete/${id}`, {
        method: 'DELETE'
    })
    .then(response => response.json())
    .then(data => {
